...
n_s<-paste("s",1:3,sep="")
n_e<-paste("e",1:3,sep="")
n_is<-paste("is",1:3,sep="")
n_ia<-paste("ia",1:3,sep="")
n_r<-paste("r",1:3,sep="")
n_y<-paste("y",1:3,sep="")
...
n_bet<-paste("bet",1:3,sep="")
n_delta<-paste("delta",rep(1:3,3),"_",rep(1:3,each=3),sep="")
...
legend("top",legend= colnames(sim)[-1],lty=1:6, col=1:6)
